...
enum NotificationTypes	
{
	...
	NOTIFICATION_PLAYER_RECONNECTED						,	//network player connecting to the game.
	NOTIFICATION_PLAYER_DISCONNECTED					,	//network player disconnecting from the game.
	NOTIFICATION_TURN_MODE_SEQUENTIAL					,	//Active player transitioned to sequential turn mode.
	NOTIFICATION_TURN_MODE_SIMULTANEOUS					,	//Active player transitioned to simultaneous turn mode.
